...
public final class ARM_7 {
	...
	final static String[] InstructionName = {"mul", "mla",};
	...
	public static String disassemble(ARM7TDMI cpu, MemoryInterface memory,
		...
		String rn = (instruction == 0)
				? null
				: cpu.getRegisterName((opcode >>> 12) & 0x0000000F);

		return InstructionName[instruction] + cond + sBit + " " + rd + ", " + rm
				+ ", " + rs + ((rn == null) ? "" : ", " + rn);
	}
