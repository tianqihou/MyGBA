...
public final class ARM_6 {
	...
	public static void execute(ARM7TDMI cpu, MemoryInterface memory,
		...
		if ((opcode & 0x00200000) == 0) {
			...
			if ((opcode & 0x02000000) == 0) {
				...
				if (shiftAmount != 0) {
					operand = (operand << (32 - shiftAmount))
							| (operand >>> shiftAmount);
				}
			}

			if (cpu.getMode() != ARM7TDMI.USRMode) {
	...
	final static String[] InstructionName = {"mrs", "msr",};
	...
	public static String disassemble(ARM7TDMI cpu, MemoryInterface memory,
		...
		String psr = cpu
				.getRegisterName(((opcode >>> 22) & 0x00000001) | 0x00000010);
