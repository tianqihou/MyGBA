...
public final class ObjectMemory extends MemoryManager_16_32 {
	...
	public int getXCoordinate(int objNumber) {
		int objAttributesAddress = (objNumber << 3);
		return ((space[objAttributesAddress + 2] & 0x000000FF)
				| ((space[objAttributesAddress + 3] << 31) >> 23));
	}
	...
	public int getTileNumber(int objNumber) {
		int objAttributesAddress = (objNumber << 3);
		return ((space[objAttributesAddress + 4] & 0x000000FF)
				| ((space[objAttributesAddress + 5] & 0x00000003) << 8));
	}
