...
abstract class MemoryManager implements MemoryInterface {
	...
	public final short getHalfWord(int offset) {
		...
		return (short) ((space[offset] & 0x00FF) | (space[offset + 1] << 8));
	}
	...
	protected final void handleAccessViolation(int offset) {
		System.out.println("Memory access violation at "
				+ Hex.toAddrString(offset, Hex.Word) + " (" + name + ")");
	}
