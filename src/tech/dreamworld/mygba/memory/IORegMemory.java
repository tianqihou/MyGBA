...
import tech.dreamworld.mygba.dma.DMA;
...
import tech.dreamworld.mygba.time.Timer;

public final class IORegMemory extends MemoryManager_8_16_32 {

	// LCD registers
	public final static int REG_DISPCNT = 0x0000, // LCD control
			...
			REG_WINOUT = 0x004A, // Control outside of windows and inside of OBJ
									// window
	...
	// DMA registers
	public final static int REG_DMA0SAD = 0x00B0, // DMA0 source address
	...
	// Timer registers
	public final static int REG_TM0D = 0x0100, // Timer0 counter/reload
	...
	public final static int REG_P1 = 0x130, // Key status
			REG_P1CNT = 0x132; // Key interrupt control

	// Interrupt, Waitstate and Power-down control registers
	public final static int REG_IE = 0x0200, // Interrupt Enable
	...
	public byte loadByte(int offset) {
		...
		switch (offset16) {
			// DMA0
			case REG_DMA0SAD :
				setHalfWord(offset16, dma0.getSourceLRegister());
				break;
			case REG_DMA0SAD + 2 :
				setHalfWord(offset16, dma0.getSourceHRegister());
				break;
			case REG_DMA0DAD :
				setHalfWord(offset16, dma0.getDestinationLRegister());
				break;
			case REG_DMA0DAD + 2 :
				setHalfWord(offset16, dma0.getDestinationHRegister());
				break;
			case REG_DMA0CNT_L :
				setHalfWord(offset16, dma0.getCountRegister());
				break;
			case REG_DMA0CNT_H :
				setHalfWord(offset16, dma0.getControlRegister());
				break;

			// DMA1
			case REG_DMA1SAD :
				setHalfWord(offset16, dma1.getSourceLRegister());
				break;
			case REG_DMA1SAD + 2 :
				setHalfWord(offset16, dma1.getSourceHRegister());
				break;
			case REG_DMA1DAD :
				setHalfWord(offset16, dma1.getDestinationLRegister());
				break;
			case REG_DMA1DAD + 2 :
				setHalfWord(offset16, dma1.getDestinationHRegister());
				break;
			case REG_DMA1CNT_L :
				setHalfWord(offset16, dma1.getCountRegister());
				break;
			case REG_DMA1CNT_H :
				setHalfWord(offset16, dma1.getControlRegister());
				break;

			// DMA2
			case REG_DMA2SAD :
				setHalfWord(offset16, dma2.getSourceLRegister());
				break;
			case REG_DMA2SAD + 2 :
				setHalfWord(offset16, dma2.getSourceHRegister());
				break;
			case REG_DMA2DAD :
				setHalfWord(offset16, dma2.getDestinationLRegister());
				break;
			case REG_DMA2DAD + 2 :
				setHalfWord(offset16, dma2.getDestinationHRegister());
				break;
			case REG_DMA2CNT_L :
				setHalfWord(offset16, dma2.getCountRegister());
				break;
			case REG_DMA2CNT_H :
				setHalfWord(offset16, dma2.getControlRegister());
				break;

			// DMA3
			case REG_DMA3SAD :
				setHalfWord(offset16, dma3.getSourceLRegister());
				break;
			case REG_DMA3SAD + 2 :
				setHalfWord(offset16, dma3.getSourceHRegister());
				break;
			case REG_DMA3DAD :
				setHalfWord(offset16, dma3.getDestinationLRegister());
				break;
			case REG_DMA3DAD + 2 :
				setHalfWord(offset16, dma3.getDestinationHRegister());
				break;
			case REG_DMA3CNT_L :
				setHalfWord(offset16, dma3.getCountRegister());
				break;
			case REG_DMA3CNT_H :
				setHalfWord(offset16, dma3.getControlRegister());
				break;

			// Timers
			case REG_TM0D :
				setHalfWord(offset16, timer0.getTime());
				break;
			case REG_TM1D :
				setHalfWord(offset16, timer1.getTime());
				break;
			case REG_TM2D :
				setHalfWord(offset16, timer2.getTime());
				break;
			case REG_TM3D :
				setHalfWord(offset16, timer3.getTime());
				break;
		}
	...
	private static short getValue16(boolean isOffsetAligned, short oldValue,
			byte newValue) {
		return (short) (isOffsetAligned
				? ((oldValue & 0xFF00) | (newValue & 0x00FF))
	...
	public void storeByte(int offset, byte value) {
		...
		short value16 = getValue16(isOffsetAligned, getHalfWord(offset16),
				value);
		...
		switch (offset16) {
			...
			// DMA0
			case REG_DMA0SAD :
				dma0.setSourceLRegister(value16);
				break;
			case REG_DMA0SAD + 2 :
				dma0.setSourceHRegister(value16);
				break;
			case REG_DMA0DAD :
				dma0.setDestinationLRegister(value16);
				break;
			case REG_DMA0DAD + 2 :
				dma0.setDestinationHRegister(value16);
				break;
			case REG_DMA0CNT_L :
				dma0.setCountRegister(value16);
				break;
			case REG_DMA0CNT_H :
				dma0.setControlRegister(value16);
				break;

			// DMA1
			case REG_DMA1SAD :
				dma1.setSourceLRegister(value16);
				break;
			case REG_DMA1SAD + 2 :
				dma1.setSourceHRegister(value16);
				break;
			case REG_DMA1DAD :
				dma1.setDestinationLRegister(value16);
				break;
			case REG_DMA1DAD + 2 :
				dma1.setDestinationHRegister(value16);
				break;
			case REG_DMA1CNT_L :
				dma1.setCountRegister(value16);
				break;
			case REG_DMA1CNT_H :
				dma1.setControlRegister(value16);
				break;

			// DMA2
			case REG_DMA2SAD :
				dma2.setSourceLRegister(value16);
				break;
			case REG_DMA2SAD + 2 :
				dma2.setSourceHRegister(value16);
				break;
			case REG_DMA2DAD :
				dma2.setDestinationLRegister(value16);
				break;
			case REG_DMA2DAD + 2 :
				dma2.setDestinationHRegister(value16);
				break;
			case REG_DMA2CNT_L :
				dma2.setCountRegister(value16);
				break;
			case REG_DMA2CNT_H :
				dma2.setControlRegister(value16);
				break;

			// DMA3
			case REG_DMA3SAD :
				value16 = getValue16(isOffsetAligned, dma3.getSourceLRegister(),
						value);
				dma3.setSourceLRegister(value16);
				break;
			case REG_DMA3SAD + 2 :
				value16 = getValue16(isOffsetAligned, dma3.getSourceHRegister(),
						value);
				dma3.setSourceHRegister(value16);
				break;
			case REG_DMA3DAD :
				value16 = getValue16(isOffsetAligned,
						dma3.getDestinationLRegister(), value);
				dma3.setDestinationLRegister(value16);
				break;
			case REG_DMA3DAD + 2 :
				value16 = getValue16(isOffsetAligned,
						dma3.getDestinationHRegister(), value);
				dma3.setDestinationHRegister(value16);
				break;
			case REG_DMA3CNT_L :
				value16 = getValue16(isOffsetAligned, dma3.getCountRegister(),
						value);
				dma3.setCountRegister(value16);
				break;
			case REG_DMA3CNT_H :
				value16 = getValue16(isOffsetAligned, dma3.getControlRegister(),
						value);
			...
			// Timers
			case REG_TM0D :
				timer0.setTime(value16);
				break;
			case REG_TM0CNT :
				timer0.updateState(value16);
				break;
			case REG_TM1D :
				timer1.setTime(value16);
				break;
			case REG_TM1CNT :
				timer1.updateState(value16);
				break;
			case REG_TM2D :
				timer2.setTime(value16);
				break;
			case REG_TM2CNT :
				timer2.updateState(value16);
				break;
			case REG_TM3D :
				timer3.setTime(value16);
				break;
			case REG_TM3CNT :
				timer3.updateState(value16);
				break;
	...
	private final static int[] BGBit = {0x01, 0x02, 0x04, 0x08,},
			WinBit = {0x20, 0x40,},
			REG_BGxCNT = {REG_BG0CNT, REG_BG1CNT, REG_BG2CNT, REG_BG3CNT,},
			REG_BGxHOFS = {REG_BG0HOFS, REG_BG1HOFS, REG_BG2HOFS, REG_BG3HOFS,},
			REG_BGxVOFS = {REG_BG0VOFS, REG_BG1VOFS, REG_BG2VOFS, REG_BG3VOFS,},
			REG_BGxX = {0, 0, REG_BG2X, REG_BG3X,},
			REG_BGxY = {0, 0, REG_BG2Y, REG_BG3Y,},
			REG_BGxPA = {0, 0, REG_BG2PA, REG_BG3PA,},
			REG_BGxPB = {0, 0, REG_BG2PB, REG_BG3PB,},
			REG_BGxPC = {0, 0, REG_BG2PC, REG_BG3PC,},
			REG_BGxPD = {0, 0, REG_BG2PD, REG_BG3PD,};
	...
	public final static short VBlankInterruptBit = 0x0001,
			HBlankInterruptBit = 0x0002, VCounterMatchInterruptBit = 0x0004;
	...
	public void generateInterrupt(short interruptBit) {
		setHalfWord(REG_IF, (short) (getHalfWord(REG_IF)
				| (getHalfWord(REG_IE) & interruptBit)));
	}
	...
	public void enterHBlank() {
		...
		if (isVCounterMatchInterruptEnabled()
				&& (scanline == getVCountSetting())) {
